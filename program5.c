//Implement circular linked list (Insert at the head, insert at tail, insert at a position, delete at the
//head, delete at tail, delete form a position, search an element).
#include <stdio.h>
#include <stdlib.h>
